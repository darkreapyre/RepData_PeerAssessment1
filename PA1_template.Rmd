...
To analyse the number of steps taken per day, the data is broken down by day and totaled.
...
```
The Mean is: `r meanByDate` (Ignoring NA Values)
The Median is: `r medianByDate` (Ignoring NA Values)
